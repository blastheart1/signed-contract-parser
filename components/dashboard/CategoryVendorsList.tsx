...
interface CategoryVendorsListProps {
  vendors: Vendor[];
}

export default function CategoryVendorsList({ vendors }: CategoryVendorsListProps) {
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Vendors working in this category</CardDescription>
        </CardHeader>
        <CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>All vendors working in this category with detailed metrics</CardDescription>
      </CardHeader>
      <CardContent>
