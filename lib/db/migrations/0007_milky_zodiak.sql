...
ALTER TABLE "alert_acknowledgments" ADD CONSTRAINT "alert_acknowledgments_customer_id_customers_dbx_customer_id_fk" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("dbx_customer_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
